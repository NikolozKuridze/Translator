...
public abstract class SearchValue
{
    ...
    public class SearchValueHandler : IRequestHandler<SearchValue.Command, PaginatedResponse<GetAllValues.Response>>
{
    ...
    public async Task<PaginatedResponse<GetAllValues.Response>> Handle(SearchValue.Command request,
